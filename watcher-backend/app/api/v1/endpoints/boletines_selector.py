...
async def list_boletines(
    month: int | None = Query(8, description="Mes (1-12)"),
    year: int | None = Query(2025, description="Año"),
    section: int | None = Query(None, description="Filtrar por sección (1-5)"),
