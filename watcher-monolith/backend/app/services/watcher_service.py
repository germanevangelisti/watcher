"""
Servicio para análisis de contenido usando OpenAI - Versión optimizada con manejo de tokens
"""
...
class WatcherService:
    """Servicio optimizado para análisis de contenido con manejo de límites de tokens."""
    ...
    def __init__(self):
        ...
        self.model = "gpt-3.5-turbo"  # Más económico y con límites más altos
        self.max_tokens_per_request = 2000  # Límite conservador por fragmento
        self.max_tokens_per_minute = 80000  # Límite de GPT-3.5-turbo
