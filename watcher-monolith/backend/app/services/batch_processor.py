...
class BatchProcessor:
    ...
    def __init__(self, db: AsyncSession, use_mock: bool = True):
        ...
        Args:
            ...
            use_mock: Si usar servicio mock (True) o real (False)
        """
        self.db = db
        self.content_extractor = ContentExtractor()
        self.watcher_service = MockWatcherService() if use_mock else WatcherService()
    ...
    async def _process_single_pdf(self, pdf_path: Path) -> Dict:
        ...
        async with AsyncSessionLocal() as file_db:
            try:
                ...
                # Extraer contenido
                sections = await self.content_extractor.extract_from_pdf(pdf_path)
